...
qplot(residual.sugar, data = whitewine, binwidth = .1) +
  coord_cartesian(xlim=c(20, max(whitewine$residual.sugar +1)), ylim = c(0,3))
...
ggplot(aes(x = as.factor(quality), 
  ...
  # Adding a geom_point layer on top of  the boxplot:
...
ggplot(aes(x = as.factor(quality),
  ...
  coord_cartesian(ylim = c(0.9875,1))
...
ggplot(aes(x = alcohol, y = density), data = whitewine) +
  ...
  scale_y_log10() +
  coord_cartesian(xlim = c(8.5,13.5), ylim = c(0.988,1.001))
...
ggplot(aes(x = alcohol, y = total.sulfur.dioxide), data = whitewine) +
  geom_point(alpha = 1/20, size = 2, position = 'jitter', color = "blue") +
  geom_smooth(method  = "loess") +
  coord_cartesian(xlim = c(8.5,13.5), ylim = c(25,300))
...
ggplot(aes(x = density, y = total.sulfur.dioxide), data = whitewine) +
  geom_point(alpha = 1/5, size = 2, position = 'jitter', color = "darkgreen") +
  xlim(c(0.9875,1.0025)) +
  ylim(c(0,275)) +
  geom_smooth(method = "loess")
...
ggplot(aes(x = total.sulfur.dioxide, 
       ...
       data = whitewine) +
  geom_point(alpha = 1/10, size = 2, position = 'jitter', color = "blue") +
  xlim(c(0,225)) +
  ylim(c(0,70)) +
  geom_smooth(method = "loess")
...
ggplot(aes(x = alcohol, y = quality), data = whitewine) +
  geom_point(alpha = 1/10, size = 2, position = 'jitter', color = "red") +
  geom_smooth(method  = "loess") +
  coord_cartesian(xlim = c(8.5,13.5))
...
ggplot(aes(x = alcohol, y = density), data = whitewine) +
  geom_point(alpha = 1/6, size = 2.5, position = 'jitter', 
             aes(color = as.factor(quality))) +
  scale_color_manual(values = quality.colors) +
  coord_cartesian(xlim=c(8.5,13.5), ylim = c(0.9875,1.0025)) + 
  geom_smooth(method = "loess") + 
...
ggplot(aes(y=alcohol, x = as.factor(quality),  color = as.factor(quality)),
  ...
  # Adding a geom_point layer on top of  the boxplot:
  geom_point(alpha = 1/10, size = 2, position = 'jitter') +
  ylab("Alcohol content in percent by volume") +
  xlab("Quality level") +
...
ggplot(aes(x=pH),data =whitewine) + 
  ...
  facet_wrap(~quality, ncol =2) +  
  xlab("pH value") +
  ylab("Density of pH value distribution") +
  ggtitle('Density of pH values facetted by Quality')
...
ggplot(aes(x = free.sulfur.dioxide.proportion, 
  ...
  geom_point(alpha = 1/5, size = 2, position = 'jitter') +
  scale_colour_manual(values = quality.colors) + 
  xlab("Proportion of Free Sulfur Dioxide (mg/litre) to
       Total Sulfur Dioxode (mg/litre)" ) +
  ylab("Alcohol in percent by volume") +
